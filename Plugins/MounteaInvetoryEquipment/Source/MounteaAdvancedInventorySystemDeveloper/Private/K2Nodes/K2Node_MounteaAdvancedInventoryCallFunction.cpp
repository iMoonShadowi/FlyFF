...
// NEW: use UE's AppStyle for style set name
...
FSlateIcon UK2Node_MounteaAdvancedInventoryCallFunction::GetIconAndTint(FLinearColor& outColor) const
{
	...
	{
	case EFunctionRole::Validate:
		return FSlateIcon(FAppStyle::GetAppStyleSetName(), "MAISStyleSet.K2Node_ValidateIcon.small");
	case EFunctionRole::Set:
		return FSlateIcon(FAppStyle::GetAppStyleSetName(), "MAISStyleSet.K2Node_SetterIcon.small");
	case EFunctionRole::Get:
		return FSlateIcon(FAppStyle::GetAppStyleSetName(), "MAISStyleSet.K2Node_GetterIcon.small");
	default:
